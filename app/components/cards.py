...
#     # Create the card
#     card = dbc.Card([
#         dbc.CardImg(src=item.get("image", "/assets/images/menu-items/default.jpg"), top=True),
#         dbc.CardBody([
#             html.H5(item["name"], className="card-title"),
#             html.P(item["description"], className="card-text mb-2"),
#             html.Div([
#                 html.Span(f"${item['price']:.2f}", className="price me-2"),
#                 *badges
#             ], className="mb-3"),
#             dbc.Button(
#                 "Add to Order",
